...
Bootstrap and Bayesian credible intervals agree closely for the logistic model but are less aligned in the SIR setting, where Bayesian intervals better capture posterior correlation among epidemic parameters.
...
@fig-sir shows that the posterior fit closely matches both the observed data and the true trajectory, indicating a good model fit. The change-point is correctly identified around  $\tau = 20$, capturing the peak and subsequent decline of the epidemic.
...
**Table 9 values differ - need to change the interpretation below, abstract and discussion**

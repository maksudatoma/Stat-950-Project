...
**Table 11. Effective sample sizes (ESS) for SIR model parameters after burn-in and thinning.** \[**make this like table 4**
...
**this part does not appear in my pdf (may be a formatting issue): I'm getting an error when rendering so can't check this**

...
**Shall we keep the font size 10 ?? - size 9 looks too small[Yes!]** 
...
**Table 4: Effective sample sizes (ESS) for each parameter after burn-in and thinning. [Instead of table we can just describe it, right?**
...
**At very last might put Dixon's paper in appropriate place [Actually neither paper is related to our work. should we need any more reference?**

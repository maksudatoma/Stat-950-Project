...
\title{Change-Point Detection in Logistic and Epidemic Models:
Computational and Inferential Consequences}
...
\phantomsection\label{logistic-growth-model-1}
...
\textbf{\(r_1\) estimated more precisely than \(r_2\) - is this
correct?? (intervals are kind of similar)}
\end{column}
\end{columns}
\end{frame}
...
\phantomsection\label{logistic-mcmc-tuning-and-diagnostics}
\begin{itemize}
\item
...
{\centering \includegraphics[width=1\textwidth,height=\textheight]{trace.png}
...
{\centering \includegraphics[width=1\textwidth,height=\textheight]{ACF.png}
...
{\centering \includegraphics[width=1\textwidth,height=\textheight]{ci.png}
...
\textbf{plot and the description do not match- need to check in the
report also(2.3.2),added the slide below }
\end{column}
\end{columns}
\end{frame}

\begin{frame}{Bootstrap vs Bayesian: Logistic Model}
\phantomsection\label{bootstrap-vs-bayesian-logistic-model-1}
\begin{longtable}[]{@{}lll@{}}
\toprule\noalign{}
...
\phantomsection\label{sir-estimation-simulation}
\begin{columns}[T]
\begin{column}{0.45\textwidth}
...
\item
  Slightly wider interval for \(\beta_2\) reflects post-change
  uncertainty
\end{itemize}
\end{column}
\end{columns}
...
\phantomsection\label{sir-mcmc-tuning-and-diagnostics}
\begin{itemize}
\tightlist
\item
  \textbf{Acceptance:}
...
\phantomsection\label{sir-mcmc-diagnostics-trace-and-acf}
\begin{columns}[T]
\begin{column}{0.5\textwidth}
\begin{figure}[H]

{\centering \includegraphics[width=1\textwidth,height=\textheight]{trace-2.png}
...
{\centering \includegraphics[width=1\textwidth,height=\textheight]{ACF-2.png}
...
{\centering \includegraphics[width=1\textwidth,height=\textheight]{SIR.png}
...
\phantomsection\label{runtime-numerical-stability}
...
\phantomsection\label{sensitivity-identifiability}
...
\item
  Main conclusion:model structure strongly affects identifiability,
  computational cost, and uncertainty quantification \textbf{shall we
  add future directions also (shortly)}
\end{itemize}
\end{frame}

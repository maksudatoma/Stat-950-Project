...
\begin{frame}{SIR MCMC Tuning and Diagnostics}
\protect\phantomsection\label{sir-mcmc-tuning-and-diagnostics}
\begin{itemize}
\tightlist
\item
  \textbf{Acceptance:}
...
\begin{frame}{SIR MCMC Diagnostics: Trace and ACF}
\protect\phantomsection\label{sir-mcmc-diagnostics-trace-and-acf}
\begin{columns}[T]
\begin{column}{0.5\linewidth}
\begin{figure}[H]

{\centering \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{trace-2.png}
...
{\centering \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{ACF-2.png}

...
- Metrics:bias, RMSE, change-point detection accuracy, AIC-based model selection

**Combine 10 & 11 and remove procedure, change the heading**
...
**remove slide 15 and just keep the plots**
